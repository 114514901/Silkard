<div align="center">
  ...
  <p align="center">
    ...
    <a href="https://fabricmc.net//">
      <img alt="Fabric" src="https://img.shields.io/badge/Fabric-26.1-FF8B00?style=flat-square">
    </a>
    ...
    <a href="https://docs.gradle.org/9.4.0/release-notes.html">
      <img alt="Gradle" src="https://img.shields.io/badge/Gradle-9.4.0-02303A?logo=gradle&logoColor=white&style=flat-square">
    </a>
...
|-------------|---------------------------------------------------------------------|-----------------|--------|
| Fabric      | [GitHub](https://github.com/FabricMC/fabric-api.git)                | Mod support     | ✅      |
...
| Arclight    | [GitHub](https://github.com/IzzelAliz/Arclight.git)                 | FabricInstaller | ✅      |
